  ...
  return (
    <div className="Nav" >
      ...
      <ul className="nav-menu">
        ...
        <li onClick={()=>{setCat("dimaond")}}><Link style = {{textDecoration: 'none'}}to='/659a167a6833c57aa3ae0b10'>Dimaond</Link>{cat==="dimaond"?<hr/>:<></> }</li>
        
        <li onClick={()=>{setCat("gold")}}><Link style = {{textDecoration: 'none'}}to='/659a16696833c57aa3ae0b0e'>GOLD</Link>{cat==="gold"?<hr/>:<></> }</li>
        <li onClick={()=>{setCat("silver")}}><Link style = {{textDecoration: 'none'}}to='/659a165f6833c57aa3ae0b0c'>SLIVER</Link>{cat==="silver"?<hr/>:<></> }</li>
      </ul>
